  ...
  <div class="container">
    <div class="component">
      <ul class="grid">
        ...
        <li class="ot-letter-left"><span data-letter="0">0</span></li>
        <li class="ot-letter-left"><span data-letter="4">4</span></li>
        <li class="ot-letter-right"><span data-letter="4">4</span></li>
        <li class="ot-letter-left"><span data-letter="0">0</span></li>
        <li class="ot-letter-top"><span data-letter="4">4</span></li>
        ...
        <li class="ot-letter-top"><span data-letter="F">F</span></li>
