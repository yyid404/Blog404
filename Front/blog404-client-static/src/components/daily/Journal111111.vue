  ...
  <div class="container">
    <el-container>
      ...
      <div class="container-content">
        ...
        <div class="content">
          <el-timeline>
            <el-timeline-item timestamp="2020/8/4" placement="top" color="#83A0B9">
              <el-card>
                <h4>UPDATE journal</h4>
                <img class="timeline-pic" src="https://myblog-pics.oss-cn-shenzhen.aliyuncs.com/journal/journal-Lemon-1.jpg">
                <p>Commit by Lemon 2020/8/4 3:42</p>
              </el-card>
